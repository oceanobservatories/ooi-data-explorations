...
if strcmp(mooring_name,'CE02SHSM') && strcmp(node,'BUOY')
    uframe_dataset_name = 'CE02SHSM/SBD12/04-PCO2AA000/telemetered/pco2a_a_dcl_instrument_air';
elseif strcmp(mooring_name,'CE04OSSM') && strcmp(node,'BUOY')
    uframe_dataset_name = 'CE04OSSM/SBD12/04-PCO2AA000/telemetered/pco2a_a_dcl_instrument_air';
elseif strcmp(mooring_name,'CE07SHSM') && strcmp(node,'BUOY')
    uframe_dataset_name = 'CE07SHSM/SBD12/04-PCO2AA000/telemetered/pco2a_a_dcl_instrument_air';
elseif strcmp(mooring_name,'CE09OSSM') && strcmp(node,'BUOY')
    uframe_dataset_name = 'CE09OSSM/SBD12/04-PCO2AA000/telemetered/pco2a_a_dcl_instrument_air';
else
