...
for year = 2014:2018
    ...
    ylabel('m/s')
    title('CE09OSSM Meridional Winds','fontweight','normal','position',[datenum(year,3,15), 10.5, 0]);
...
for year = 2014:2018
    ...
    set(gca,'TickLength',[0.005, 0.005])
    ylabel('m/s')
    title('CE09OSSM Meridional Winds','fontweight','normal','position',[datenum(year,9,15), 10.5, 0]);
