...
PYTHON="python -m instruments.python.flort.request_flort"
...
# Current deployment
$PYTHON $BASE_FLAGS -mt telemetered -st flort_sample -ba -dp 08 -o "$BASE_FILE.deploy08.telemetered.flort_sample.nc"
...
# Current deployment
$PYTHON $BUOY_FLAGS -mt telemetered -st flort_sample -dp 10 -o "$BUOY_FILE.deploy10.telemetered.flort_sample.nc"
$PYTHON $NSIF_FLAGS -mt telemetered -st flort_sample -ba -dp 10 -o "$NSIF_FILE.deploy10.telemetered.flort_sample.nc"
