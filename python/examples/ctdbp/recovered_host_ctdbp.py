...
from python.ooi_data_explorations.uncabled.process_ctdbp import ctdbp_datalogger
...
def main():
    ...
    ctdbp.to_netcdf(nc_out, mode='w', format='NETCDF4', engine='h5netcdf', encoding=ENCODINGS)
