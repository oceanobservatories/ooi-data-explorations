...
def process_fdchp(raw_data, latitude, anemometer_relative_position, tc1=20, tcwave=30, despike=True, despikecompass=False, flux_filepath=None):
    ...
    fc1=1/tc1 #TODO: unused?                  #    determined by the tilt of the accelerometers at low frequencies versus the 
    fc2=1/tc2 #TODO: unused?                   #    integrated angular rates at high frequencies.  This is known as complementary
    tcwave=30                   #    filtering
    fcwaves=1/tcwave #TODO: unused?           # Same as above but for the wave measurements, which requires a large cutoff period
