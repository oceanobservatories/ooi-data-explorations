...
from ooi_data_explorations.cabled.process_optaa import optaa_benthic
...
# to the local disk
site = 'CE02SHBP'                               # OOI Net site designator
node = 'LJ01D'                                  # OOI Net node designator
sensor = '08-OPTAAD106'                         # OOI Net sensor designator
...
out_file = ('%s.%s.%s.deploy06.%s.%s.nc' % (site.lower(), level, instrmt, method, stream))
