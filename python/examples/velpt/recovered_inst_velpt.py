...
from ooi_data_explorations.uncabled.process_velpt import velpt_instrument
...
stream = 'velpt_ab_instrument_recovered'  # OOI Net stream name
...
velpt = load_gc_thredds(site, node, sensor, method, stream, 'deployment0018.*VELPT.*\\.nc$')

# clean-up and reorganize
velpt = velpt_instrument(velpt)
