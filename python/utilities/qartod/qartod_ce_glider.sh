...
python -m ooi_data_explorations.qartod.endurance.qartod_ce_glider_ctdgv -s CE05MOAS
python -m ooi_data_explorations.qartod.endurance.qartod_ce_glider_dosta -s CE05MOAS
python -m ooi_data_explorations.qartod.endurance.qartod_ce_glider_flort -s CE05MOAS
python -m ooi_data_explorations.qartod.endurance.qartod_ce_glider_parad -s CE05MOAS
