#!/usr/bin/env bash
#
# qartod_ce_glider_ctdgv.sh
#
# Collect all CE glider CTD data from the IOOS GliderDAC to calculate QARTOD
...
conda activate ooi
PYTHON="python -m ooi_data_explorations.qartod.endurance.qartod_ce_glider_ctdgv"

### CE05MOAS ###
$PYTHON -s CE05MOAS -n GL311 -sn 05-CTDGVM000
